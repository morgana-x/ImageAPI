...
## This is more of a fun plugin rather than a practical and applicable plugin on your server - Mostly due to the potentiol issues of lag and that whole falling into floor glitch - Aka only use it for mucking around on a quiet server or something
# Features
+ Image downscaling
